...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            mGanHuos = (List<GanHuo>) getIntent().getSerializableExtra("beans");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            String pic = getArguments().getString(ARG_SECTION_NUMBER);
            String picPath = ImgCacheManager.createFile(getContext(), pic).getAbsolutePath();
            Glide.with(this)
                    .load(picPath)
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return PlaceholderFragment.newInstance(mGanHuos.get(position).getUrl());
        }

        @Override
        public int getCount() {
            // Show 3 total pages.
            return mGanHuos.size();
        }
